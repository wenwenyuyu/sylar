...
public:
  ...
  std::string getParams(const std::string &key,
                        const std::string &def = "") const;
  std::string getCookies(const std::string &key,
                         const std::string &def = "") const;
  ...
  template <class T> T getParamsAs(const std::string &key, const T &def = T()) {
  ...
  template <class T> T getCookiesAs(const std::string &key, const T &def = T()) {
...
public:
  ...
  void setHearders(const MapType &v) { m_headers = v; }
