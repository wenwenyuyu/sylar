/*
 * @Author       : wenwneyuyu
 * @Date         : 2024-05-11 14:38:39
 * @LastEditors  : wenwenyuyu
 * @LastEditTime : 2024-05-11 15:10:00
 * @FilePath     : /tests/test_bytearray.cc
 * @Description  : 
...
#define XX(type, len, write_fun, read_fun, base_len)                           \
    {                                                                          \
      ...
      SYLAR_LOG_INFO(g_logger)                                                 \
          ...
          << " base_len=" << base_len << " size=" << ba->getSize();            \
      ba->setPosition(0);                                                      \
      SYLAR_ASSERT(ba->writeToFile("/home/wenwenyuyu/sylar/logs/" #type        \
                                   "_" #len "-" #read_fun ".dat"));            \
      sylar::ByteArray::ptr ba2(new sylar::ByteArray(base_len * 2));           \
      SYLAR_ASSERT(ba2->readFromFile("/home/wenwenyuyu/sylar/logs/" #type      \
                                     "_" #len "-" #read_fun ".dat"));          \
      ba2->setPosition(0);                                                     \
